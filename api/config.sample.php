...
define('FACEINSIGHT_STRIPE_SECRET_KEY', 'PASTE_STRIPE_SECRET_KEY_HERE');
define('FACEINSIGHT_STRIPE_PUBLISHABLE_KEY', 'PASTE_STRIPE_PUBLISHABLE_KEY_HERE');
define('FACEINSIGHT_STRIPE_WEBHOOK_SECRET', 'PASTE_STRIPE_WEBHOOK_SECRET_HERE');
